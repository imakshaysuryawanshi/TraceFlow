...
- **Phase 2 – UI Layout**: top bar (brand + sample dropdown + kbd hint), 3-column main, bottom timeline + output.
- **Phase 3 – Monaco**: read-only Java editor, custom `traceflow-dark` theme, current-line decoration + gutter glyph.
